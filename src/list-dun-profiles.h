...
DUN("cavern", cavern)
DUN("classic", classic)
DUN("basic small", basic_small)
DUN("tiny", tiny)
DUN("modified2", modified)
DUN("jelly pit", jelly_pit)
DUN("classic2", classic)
DUN("journey", tiny)
DUN("dogs and mushrooms", tiny)
DUN("castle p", tiny)
DUN("sil", modified)
DUN("fa mountains", modified)
DUN("one way door", owd)
